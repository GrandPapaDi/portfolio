(() => {
        ...
        if (document.querySelector(".main-block__slider")) new swiper_core_Swiper(".main-block__slider", {
            ...
            on: {
                init: function(swiper) {
                    ...
                    document.querySelector(".fraction-controll__current");
    ...
    function documentActions(e) {
        const targetElement = e.target;
        console.log("Click detected on:", targetElement);
        if (targetElement.closest("[data-parent]")) {
            ...
            } else console.log("Error: subMenu not found for ID", subMenuId);
            e.preventDefault();
        }
        ...
        if (targetElement.closest(".menu-catalog__back")) {
            console.log("Catalog back link clicked");
            document.documentElement.classList.remove("catalog-open");
            const activeLink = document.querySelector("._sub-menu-active");
            const activeBlock = document.querySelector("._sub-menu-open");
            if (activeLink) activeLink.classList.remove("_sub-menu-active");
        ...
        if (targetElement.closest(".sub-menu-catalog__back")) {
            console.log("Sub-menu back link clicked");
