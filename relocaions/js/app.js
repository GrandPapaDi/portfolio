(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero")) {
            const heroSwiper = new swiper_core_Swiper(".hero", {
            ...
            function updateSwiperDirection() {
                if (window.innerWidth <= 650) heroSwiper.changeDirection("horizontal"); else heroSwiper.changeDirection("vertical");
            }
            window.addEventListener("resize", updateSwiperDirection);
            updateSwiperDirection();
        }
        if (document.querySelector(".common__slider")) new swiper_core_Swiper(".common__slider", {
        ...
        if (document.querySelector(".map__slider")) new swiper_core_Swiper(".map__slider", {
            modules: [ Navigation, Pagination, Parallax, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
