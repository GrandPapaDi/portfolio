(() => {
    ...
    function initSliders() {
        if (document.querySelector(".collect")) new swiper_core_Swiper(".collect__slider", {
    ...
    if (document.querySelector(".trading")) new swiper_core_Swiper(".trading__slider", {
        modules: [ Navigation, Pagination, Parallax ],
        observer: true,
        observeParents: true,
        slidesPerView: 4,
        ...
        navigation: {
            prevEl: ".trading__button-prev",
            nextEl: ".trading__button-next"
        },
        breakpoints: {
            320: {
                slidesPerView: 1,
