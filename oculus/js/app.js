(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const video = document.querySelector(".activity__video");
        const playButton = document.querySelector(".activity__play");
        const text = document.querySelector(".activity__title--botom");
